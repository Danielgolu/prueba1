...
class formularioprocesos extends React.Component{
    constructor(props){
        super(props)
        this.state={
                criterio:[],
        ...
        return(
            <div>
                ...
                <div className="container" >
                        ...
                        <div className="row ">
                            <div className="col-md-12"><h4 >Datos del Proceso</h4></div>
                        </div>
                        <br></br>
                        <div className="row sombra">
                            <div className="col-md-3"><h6 >Autorizacion:</h6></div>
                            <div className="col-md-9"><input style={{ borderRadius:"10px", borderColor:'#000000',backgroundColor:'#35BF8D'}} className="estilo" type="text" id="autorizacion"/></div>
                        </div>
                        <div className="row sombra">
                            <div className="col-md-3"><h6 >Asesor:</h6></div>
                            <div className="col-md-9"><input style={{ borderRadius:"10px", borderColor:'#000000',backgroundColor:'#35BF8D'}} className="estilo" type="text" id="autorizacion" /></div>
                        </div>

                        <div className="row sombra">
                            <div className="col-md-3"><h6 >Dictamen Jurado de Tesis:</h6></div>
                            <div className="col-md-9"><input style={{ borderRadius:"10px", borderColor:'#000000',backgroundColor:'#35BF8D'}} className="estilo" type="text" id="autorizacion" /></div>
                        </div>

                        
                        <div className="row sombra">
                            <div className="col-md-3"><h6 >Presidente:</h6></div>
                            <div className="col-md-9"><input style={{ borderRadius:"10px", borderColor:'#000000',backgroundColor:'#35BF8D'}} className="estilo" type="text" id="autorizacion" /></div>
                        </div>
                        ...
                        <div className="row sombra">
                            ...
                            <div className="col-md-9"><textarea style={{borderColor:'#000000',backgroundColor:'#FFFFFF'}} rows="10" cols="40"></textarea> </div>
                        </div>
...
export default formularioprocesos
