...
class LoginForm2 extends React.Component {
    ...
    //El metodo OnSubmit 1.- ValidarNombre retorna true o false, para ver si han escrito algo
    //2.-toUppercase.-Transforma todo en Arreglo lo escrito en un solo arreglo
    //3.-slip separa el texto por espacios y lo almacena en arreglodeSubCadenas
    //4.-lo allmacena en arreglo usando el for 
    onSubmit2=(e)=>{
      ...
      //Join te los junta con la letra & las palabras en una sola cadena ejm daniel&renzo&gomez
