...
import FormularioIntermioprocesos from './formulario-intermedioprocesos';
...
class App extends React.Component {
  ...
  //------------------------------EMPIEZA LA LOGICA-----------------------------
  //linea de codigo 442 agregada por daniel
  //reacomodar condicionales de renderizado
  render() {
    if (this.state.pagos.length > 0) {
      if (this.state.aparecer == true) {
        return (
          ...
          <div className="">
            ...
            <div>
              <h3 style={{paddingTop :20, paddingBottom:40}}>Estado de pagos por alumno 
                <ul style={{paddingTop:8}}id="nav-mobile" className=" row right  hide-on-med-and-down">
                  <li ><a className="seleccionar col" onClick={this.enviarFormulario2} >Iniciar Proceso<i className="material-icons right">edit</i></a></li>
        ...
        if (this.state.aparecer1 == true) {
          ...
          return (
            <div>
              ...
              <footer>
                <div className="row center-xs centrar color">
                  <img src="https://png.icons8.com/ios/1600/hachiko.png" height="25" />
                  UPG-FISI © 2019 si entro beneficio
                </div>
              </footer>
            </div>
          ...
          return (
            <div>
              ...
              <FormularioIntermioprocesos codigo={this.state.name} idprograma={this.state.pagos[0].idPrograma} />
              <footer>
                <div className="row center-xs centrar color">
                  <img src="https://png.icons8.com/ios/1600/hachiko.png" height="25" />
                  UPG-FISI © 2019 si entro proceso
                </div>
              </footer>
            </div>
